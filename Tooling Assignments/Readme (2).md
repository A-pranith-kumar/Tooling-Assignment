...
```bash
git config --global user.name "A-pranith-kumar"
git config --global user.email "pranith415@gmail.com"
```
...
![picture](./virtualbox%20version.png)
...
![picture](./video2.1.png)

![picture](./video3.png)

![picture](./video3.1.png)

![picture](./video%203.2.png)

![picture](./video4.png)

![picture](./video%204.1.png)
